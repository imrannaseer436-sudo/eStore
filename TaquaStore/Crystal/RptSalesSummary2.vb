...
Public Class RptSalesSummary2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TaquaStore.RptSalesSummary2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSalesSummary2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSalesSummary2 = New RptSalesSummary2()
        rpt.Site = Me.Site
        Return rpt
    End Function
