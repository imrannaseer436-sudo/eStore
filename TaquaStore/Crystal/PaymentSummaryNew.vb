...
Public Class PaymentSummaryNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TaquaStore.PaymentSummaryNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentSummaryNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentSummaryNew = New PaymentSummaryNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
