...
Public Class RptReturnFromShops
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TaquaStore.RptReturnFromShops.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Duration() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptReturnFromShops
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptReturnFromShops = New RptReturnFromShops()
        rpt.Site = Me.Site
        Return rpt
    End Function
